...
def IcosphereTriangles(color=(255, 255, 255), subdivision=0, radius=1):
    ...
    for i in range(subdivision):
        ...
        for triangle in triangles:
            _i0 = GetMiddlePoint(
                triangle.vertex1, triangle.vertex2, vertices, middlePointCache
            )
            _i1 = GetMiddlePoint(
                triangle.vertex2, triangle.vertex3, vertices, middlePointCache
            )
            _i2 = GetMiddlePoint(
                triangle.vertex3, triangle.vertex1, vertices, middlePointCache
            )
